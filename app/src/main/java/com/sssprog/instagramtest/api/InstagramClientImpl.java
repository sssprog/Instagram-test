...
public class InstagramClientImpl implements InstagramClient {
    ...
    private static final String TAG = LogHelper.getTag(InstagramClientImpl.class);
    ...
    public InstagramClientImpl(String clientId, String clientSecret, String callbackUrl) {
